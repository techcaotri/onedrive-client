...
from lib.file_config_helper import (
    create_and_get_config_folder,
    force_permission_file_read_write_owner,
)
import os
import sys
...
if __name__ == "__main__":
    ...
    if hasattr(args, "settingspath"):
        tr = TokenRecorder(token_file_name, args.settingspath)
    else:
